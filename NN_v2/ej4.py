...
def main():
    ...
    plt.scatter(datos_x[v_c1_best,2], datos_x[v_c1_best,3], color=(1,0,0),label="Virginica")
    plt.scatter(datos_x[v_c2_best,2], datos_x[v_c2_best,3], color=(0,0,1),label="Versicolor")
    plt.scatter(datos_x[v_c3_best,2], datos_x[v_c3_best,3], color=(0,1,0),label="Setosa")
    plt.xlabel("Ancho (cm)")
    plt.ylabel("Alto (cm)")
    plt.title("Pétalos")
    ...
    plt.scatter(datos_x[v_c1_best,0], datos_x[v_c1_best,1], color=(1,0,0),label="Virginica")
    plt.scatter(datos_x[v_c2_best,0], datos_x[v_c2_best,1], color=(0,0,1),label="Versicolor")
    plt.scatter(datos_x[v_c3_best,0], datos_x[v_c3_best,1], color=(0,1,0),label="Setosa")
    plt.xlabel("Ancho (cm)")
    plt.ylabel("Alto (cm)")
    plt.title("Céfalos")
    plt.legend(loc="lower right", title="", frameon=False)
